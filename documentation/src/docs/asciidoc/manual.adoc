...
. Eventuella deltagare som inte har infunnit sig vid start anges som ej startande genom att trycka `Avhoppad`.
...
Deltagare visas sorterade på startnummer. Endast deltagare med status _Aktiv_ eller _Avslutad_ visas i listan (deltagare med status _Avhoppad_ och _Anmäld_ visas inte).
...
Endast deltagare med status _Anmäld_, _Aktiv_ eller _Avslutad_ visas i listan (deltagare med status _Avhoppad_ visas inte).
